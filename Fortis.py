...
st.markdown(
    ...
    "Then click **Generate Report** to run the AI and build your document."
)
...
if uploaded_file:
    ...
    # 4️⃣ Once generated, display & download
